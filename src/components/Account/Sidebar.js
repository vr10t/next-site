...
export default function Sidebar(props) {
  ...
  const active = "bg-gradient-to-r from-sky-600 to-cyan-400 text-white";
  const inactive = "text-gray-600";
  const path1Active = "text-cyan-400 dark:fill-slate-600";
  const path1Inactive = " text-gray-600 group-hover:text-cyan-600";
                  ...
                  <a
                    ...
                    <svg
                      ...
                      <path
                        ...
                        className={`fill-current ${path==="/my-account"?path1Active:path1Inactive}`}></path>
                      <path
                        d="M13 8a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2V8Z"
                        className={`fill-current ${path==="/my-account"?path2Active:path2Inactive}`}></path>
                      <path
                ...
                <Link href="/my-account/bookings">
                  ...
                  aria-label="bookings"
                    className={`group relative flex items-center space-x-4  px-4 py-3 ${
                      path === "/my-account/bookings" ? active : "text-gray-600"
                    }`}>
                    <svg
