...
export default function Announcement(props) {
  ...
  return (
    <div className={`flex fixed top-20 flex-col gap-2 justify-center items-center py-2 pr-6 pl-2 w-screen text-white bg-orange-400 shadow-md z-[21] sm:flex-row sm:justify-between`}>
