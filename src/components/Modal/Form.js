...
export default function Form() {
  ...
  return (
    <div className=" grid grid-cols-1 md:grid-cols-2 z-10 bg-stone-100   ">
    <div className="px-5 mt-4">
      <h3>Looking for a taxi?</h3>

<h1 className={` ${styles.textAni} text-5xl text-orange-500  font-bold `}>Make your booking</h1>
<h5>Our taxis commit to make your trips unique by best answering your needs.</h5>
<Image className="rounded-xl mt-4 " src="/bg-2.jpg" width="600rem" height="400rem"
/>
    </div>
    <div className="m-4">
      <form>
      ...
      <h1 className="text-center font-bold ">Book a Ride</h1>
        <div className="md:grid mx-4 xl:grid-cols-2 lg:gap-4 md:float-right">
          ...
          <div className="flex flex-col"> {/*second col*/}
            <InputField
              icon={
...
<div className="flex px-16 mt-4 flex-row">
        <input
          ...
          type="checkbox"
        />
        <label className="px-2 indent-2" for="tos">
